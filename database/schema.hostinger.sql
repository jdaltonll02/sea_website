-- ============================================================================
-- Hostinger import variant of schema.sql — CREATE DATABASE/USE stripped since
-- Hostinger provisions the database for you and your DB user isn't allowed to
-- create or select an arbitrarily-named one. In phpMyAdmin: click your actual
-- database name in the sidebar first (so it's the active DB), THEN Import
-- this file. Keep this in sync with schema.sql if that file changes.
-- ============================================================================
SET NAMES utf8mb4;
